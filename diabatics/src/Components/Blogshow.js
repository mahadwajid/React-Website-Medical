        ...
        <div>
            {blogbyid.map(details =>
                    ...
                    <div className="Blog-img">
                        <img src={`http://localhost:3000/images/${details.image}`} alt="Blog Image" className="Full-width-img" />
                    </div>
                    ...
                    <div className="Author-container">
                        <div className="author-image">
                            <img src={`http://localhost:3000/images/${details.authorImage}`} alt="Author Image" />
                        </div>
